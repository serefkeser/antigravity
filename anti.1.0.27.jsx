...
// ── App Mount: Standalone / PWA Desteği (Gemini Canvas ile çakışma önleyici) ──
if (typeof document !== 'undefined') {
  const rootEl = document.getElementById('root');
  if (rootEl && typeof ReactDOM !== 'undefined') {
    try {
      // Container halihazırda Canvas veya React 18 tarafından yönetiliyorsa createRoot tekrar çağrılmaz
      const hasReactRoot = !!(
        rootEl.__antiRoot ||
        rootEl._reactRootContainer ||
        Object.keys(rootEl).some(k => k.startsWith('__reactContainer$') || k.startsWith('__reactFiber$'))
      );
      ...
      if (typeof ReactDOM.createRoot === 'function') {
        ...
        } else if (rootEl.__antiRoot) {
          rootEl.__antiRoot.render(<App />);
        }
      } else if (typeof ReactDOM.render === 'function' && !hasReactRoot) {
